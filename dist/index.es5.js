        ...
        if (!(window === null || window === void 0 ? void 0 : window[scriptFlag]) && window.google && script === 'ready') {
            ...
            if (window.screen.width >= 768) {
                window.google.accounts.id.renderButton(
                    ...
                    { theme: "outline", size: "medium", width: "200", logo_alignment: "center" , text: "signin_with" } // customization attributes
                );
            } else {
                window.google.accounts.id.renderButton(
                    document.getElementById("googleButton"),
                    { theme: "outline", size: "medium", width: "143", logo_alignment: "center" , text: "signin" } // customization attributes
                );
            }
        }
